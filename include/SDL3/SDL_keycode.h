/*
  ...
  header SDL_keycode.h (3.2.10), which is zlib licensed, Copyright (C) 1997-2025 Sam Lantinga
  ...
  In this header: Keycodes, scancodes and modifiers. The full upstream tables are kept: they are
