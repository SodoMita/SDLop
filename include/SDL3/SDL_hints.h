/*
  ...
  header SDL_hints.h (3.2.10), which is zlib licensed, Copyright (C) 1997-2025 Sam Lantinga
  ...
  In this header: Hints. Every upstream SDL_HINT_* name is kept so existing code compiles; only the
