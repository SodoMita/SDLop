...
int main(void)
{
    ...
    V(SDL_EVENT_KEY_DOWN); V(SDL_EVENT_KEY_UP); V(SDL_EVENT_TEXT_EDITING);
    V(SDL_EVENT_TEXT_INPUT); V(SDL_EVENT_KEYMAP_CHANGED);
    V(SDL_EVENT_KEYBOARD_ADDED); V(SDL_EVENT_KEYBOARD_REMOVED);
